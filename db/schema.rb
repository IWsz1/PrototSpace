...
ActiveRecord::Schema[7.0].define(version: 2023_11_05_134734) do
  ...
  create_table "commets", charset: "utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "prototype_id"
    t.string "content", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["prototype_id"], name: "index_commets_on_prototype_id"
